...
| ------------------------------------------------- | ------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `policy` (🚫 Deprecated, use `policy-v2` instead) | `data/policy.yml`                     | Path to `vet` YAML policy file (filter suite)                                                                                                             |
| `policy-v2`                                       | `data/policy-v2.yml`                  | Path to `vet` YAML policy-v2 file (default [data/policy-v2.yml](data/policy-v2.yml) file will be used when neither `policy` nor `policy-v2` is specified) |
